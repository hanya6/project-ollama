...
class OllamaClassifier:
    ...
    def _parse_response(self, response: str) -> str:
        ...
        label_keywords = {
            "Pemeriksaan Kehamilan (ANC)": ["anc", "kehamilan", "hamil", "antenatal"],
            "Imunisasi": ["imunisasi", "vaksin", "vaksinasi"],
            "Penimbangan & Pemantauan Pertumbuhan": ["penimbangan", "pertumbuhan", "timbang"],
            "Pemberian Makanan Tambahan (PMT)": ["pmt", "makanan tambahan"],
            "Penyuluhan Kesehatan": ["penyuluhan", "edukasi", "sosialisasi"],
            "Pelayanan KB": ["kb", "keluarga berencana", "kontrasepsi"],
            "Pemeriksaan Nifas": ["nifas", "pasca persalinan"],
            "Deteksi Dini Tumbuh Kembang": ["tumbuh kembang", "ddtk", "kpsp", "sdidtk"],
        }
    ...
    def classify_batch(
        ...
        Args:
            ...
            with_reasoning: Jika True, minta LLM memberikan alasan
            delay: Jeda antar request (detik) untuk menghindari overload
        ...
        print(f"[INFO] Mode: {'Dengan Reasoning' if with_reasoning else 'Direct'}")
        print("-" * 60)
